...
public class ScenicSpotBaseAdapterspinner3 extends BaseAdapter {

	private LinkedList<Users> items;
	private LayoutInflater inflater;
	public ScenicSpotBaseAdapterspinner3(Context context){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView==null){
			convertView=inflater.inflate(R.layout.scenicspot_spinneritem3,null);
